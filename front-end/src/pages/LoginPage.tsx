      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-gray-200/50 dark:border-gray-700/50">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl shadow-lg mb-4 animate-float">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Đăng nhập để quản lý phòng học thông minh
            </p>
          </div>

          {/* Error Message */}
          {error && (
            <div className="mb-6 p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 animate-slide-up">
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          © 2026 Smart Classroom IoT. Made with ❤️ for HCMUT
        </p>
      </div>
    </div>
  );
